...
<link rel="alternate" type="application/rss+xml" title="Adventist University of Central Africa » Feed" href="https://auca.ac.rw/">
<link rel="alternate" type="application/rss+xml" title="Adventist University of Central Africa » Comments Feed" href="https://auca.ac.rw/comments/feed/">
<script id="facebook-jssdk" src="js/xfbml.customerchat.js#xfbml=1&amp;version=v6.0&amp;autoLogAppEvents=1"></script><script type="text/javascript">
    /* <![CDATA[ */
...
<link rel="stylesheet" id="single-staff-block-css" href="css/style.css" type="text/css" media="all">
<link rel="stylesheet" id="staff-list-block-css" href="css/style_2.css" type="text/css" media="all">
<link rel="stylesheet" id="search-staff-block-css" href="css/style_1.css" type="text/css" media="all">
<link rel="stylesheet" id="wpzoom-social-icons-block-style-css" href="css/style-wpzoom-social-icons.css" type="text/css" media="all">
...
<link rel="stylesheet" id="sp-news-public-css" href="css/wpnw-public.css" type="text/css" media="all">
<link rel="stylesheet" id="staff-directory-css-css" href="css/staff-directory.css" type="text/css" media="all">
<link rel="stylesheet" id="tweetscroll-css" href="css/tweetscroll.css" type="text/css" media="screen">
...
<link rel="stylesheet" id="zoom-theme-utils-css-css" href="css/theme-utils.css" type="text/css" media="all">
...
<link rel="stylesheet" id="academica-pro-style-css" href="css/style_3.css" type="text/css" media="all">
...
<link rel="stylesheet" id="abcfsl-staff-list-css" href="css/staff-list.css" type="text/css" media="all">
<link rel="stylesheet" id="tmm-css" href="css/tmm_style.css" type="text/css" media="all">
...
<script type="text/javascript" src="js/continuous-announcement-scroller.js" id="continuous-announcement-scroller-js"></script>
...
<script type="text/javascript" src="js/jquery.tweetscroll.js" id="tweetscroll-js"></script>
<script type="text/javascript" src="js/init.js" id="wpzoom-init-js"></script>
...
<link rel="icon" href="images/cropped-AUCA-Logooo-32x32.jpg" sizes="32x32">
<link rel="icon" href="images/cropped-AUCA-Logooo-192x192.jpg" sizes="192x192">
<link rel="apple-touch-icon" href="images/cropped-AUCA-Logooo-180x180.jpg">
        ...
        <div class="wrapper">
            ...
            <div class="brand_wrapper">
                ...
                <div class="navbar-brand-wpz">
                    ...
                    <a href="https://auca.ac.rw/" class="custom-logo-link" rel="home" itemprop="url"><img width="502" height="116" src="images/cropped-AUCA-logo-wide-webblue-2-1-1.png" class="custom-logo no-lazyload no-lazy a3-notlazy" alt="Adventist University of Central Africa" itemprop="logo" decoding="async" fetchpriority="high" srcset="images/cropped-AUCA-logo-wide-webblue-2-1-1.png 502w, images/cropped-AUCA-logo-wide-webblue-2-1-1-300x69.png 300w, images/cropped-AUCA-logo-wide-webblue-2-1-1-238x55.png 238w" sizes="(max-width: 502px) 100vw, 502px"></a>
        ...
        <div class="wrapper">
            ...
            <div id="sb-search" class="sb-search">
                <form method="get" class="searchform" action="https://auca.ac.rw/">
                    <input type="search" class="sb-search-input" placeholder="Search…" value="" name="s" id="s">
        ...
        <section id="slider" class="wpzoom_slider">
            ...
            <ul class="slides clearfix">
                ...
                <li class="slide">
                    ...
                    <div class="slide-background" style="background-image:url('images/March.jpg')">
                    </div>
                </li>
                ...
                <li class="slide">
                    ...
                    <div class="slide-background" style="background-image:url('images/Slider-Graduation-29.png')">
                    </div>
                </li>
                ...
                <li class="slide">
                    ...
                    <div class="slide-background" style="background-image:url('images/Slilder-Big-Data-4.png')">
                    </div>
                </li>
                ...
                <li class="slide">
                    ...
                    <div class="slide-background" style="background-image:url('images/Progs-Masters-FAQs.png')">
                    </div>
                </li>
                ...
                <li class="slide">
                    ...
                    <div class="slide-background" style="background-image:url('images/Campuses.png')">
                    </div>
                </li>
        ...
        <div class="wrapper">
            ...
            <section class="column-widgets">
                ...
                <div class="widget-column">
                    <div class="widget wpzoom-media-widget widget-none" id="wpzoom-media-widget-2"><div class="post_thumb_withbg" style="background-image:url('images/Business-Services-Online-1-365x240.jpg')"><a href="https://sis.auca.ac.rw/" target="_blank"><div class="featured_page_content"><h3 class="title">Apply Online</h3></div></a></div><div class="clear"></div></div>                        </div><!-- .column -->

                <div class="widget-column">
                    <div class="widget wpzoom-media-widget widget-none" id="wpzoom-media-widget-3"><div class="post_thumb_withbg" style="background-image:url('images/Group-365x240.jpg')"><a href="https://auca.ac.rw/contact/" target="_blank"><div class="featured_page_content"><h3 class="title">Undergraduate</h3></div></a></div><div class="clear"></div></div>                        </div><!-- .column -->

                <div class="widget-column">
                    <div class="widget wpzoom-media-widget widget-none" id="wpzoom-media-widget-4"><div class="post_thumb_withbg" style="background-image:url('images/Slider-campus-photo3-710x300-365x240.jpg')"><a href="https://auca.ac.rw/contact/" target="_blank"><div class="featured_page_content"><h3 class="title">Graduate Programmes</h3></div></a></div><div class="clear"></div></div>                        </div><!-- .column -->
            ...
            <div class="column column-narrow">
                ...
                <div class="widget zoom-social-icons-widget widget-none" id="zoom-social-icons-widget-11"><h3 class="title">Follow us</h3>
                    ...
                    <div class="cleaner">�&nbsp;</div></div><div class="widget pi_tweet_scroll widget-grey" id="pi_tweet_scroll-2"><h3 class="title">Latest Tweets</h3>        <div id="tweets-list-id-978" class="tweets-list-container aside" data-instance-id="2" data-post-id="7282"></div>

                <script>
                    jQuery(function ($) {
                        /* ================ TWEETS SCROLL ================ */
                        jQuery('#tweets-list-id-978').tweetscroll({
            ...
            <div class="widget-areas">
                ...
                <div class="column">
                    ...
                    <div class="widget widget_text widget-blue" id="text-2"><h3 class="title">Since 1984</h3>			<div class="textwidget"><h6>ADVENTIST UNIVERSITY OF CENTRAL AFRICA</h6>
                        ...
                        <small><em></em></small>
                        <p>PO Box 2461, Kigali Rwanda</p><p>
                            <small></small>
                        </p><p>Admission Inquiries: admissions@auca.ac.rw or call +250 724796998</p><p>
                        </p><p>Media Inquiries: marketing@auca.ac.rw</p><p>
                        </p><p>General Inquiries: info@auca.ac.rw</p><p>
                        </p></div>
...
<script type="text/javascript" src="js/dropdown.js" id="superfish-js"></script>
<script type="text/javascript" src="js/flickity.pkgd.min.js" id="flickity-js"></script>
<script type="text/javascript" src="js/jquery.fitvids.js" id="fitvids-js"></script>
<script type="text/javascript" src="js/search_button.js" id="search_button-js"></script>
<script type="text/javascript" id="academica-pro-script-js-extra">
    /* <![CDATA[ */
    var zoomOptions = {"slideshow_auto":"1","slideshow_speed":"3000"};
    /* ]]> */
</script>
<script type="text/javascript" src="js/functions.js" id="academica-pro-script-js"></script>
<script type="text/javascript" src="js/social-icons-widget-frontend.js" id="zoom-social-icons-widget-frontend-js"></script>
