...
<%@ page import="Service.SemesterInteface" %>
<%@ page import="Service.SemesterServiceImpl" %>
<%@ page import="model.Semester" %>
<%@ page import="model.StudentRegistration" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.ArrayList" %>
<%@ page import="Service.StudentRegService" %>
<%@ page import="Service.StudentRegServiceImpl" %>
<%@ page import="Service.AcademicService" %>
<%@ page import="Service.AcademicServiceImpl" %>
<%@ page import="model.AcademicUnit" %>
<jsp:useBean id="semBean" class="bean.SemesterBean" scope="request" />
<jsp:useBean id="unitBean" class="bean.AcademicUnitBean" scope="request" />
